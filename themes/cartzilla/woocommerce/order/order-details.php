...
<div class="woocommerce-order-details card">
	<div class="card-header">
		<h2 class="woocommerce-order-details__title h6 mb-0"><?php esc_html_e( 'Order details', 'cartzilla' ); ?></h2>
	</div>
	<div class="card-body">
		<div class="row mx-n2">
			<div class="col-md-7">
			...
			<div class="col-md-5 pt-4 pt-md-0">
				<div class="bg-secondary rounded-lg p-4 h-100">
					...
					<?php if ( $order->get_customer_note() ) : ?>
						<div class="pt-3">
							<h6 class="font-size-base"><?php esc_html_e( 'Note:', 'cartzilla' ); ?></h6>
							<p class="mb-0 font-size-sm"><?php echo wp_kses_post( nl2br( wptexturize( $order->get_customer_note() ) ) ); ?></p>
						</div>
					<?php endif; ?>
				</div>
			</div>
