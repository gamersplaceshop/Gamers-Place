	...
	<div class="media align-items-center">
		...
		<div class="media-body">
			...
			<div class="widget-product-meta">
				<span class="text-accent mr-1"><?php echo wp_kses_post( $order->get_formatted_line_subtotal( $item ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
