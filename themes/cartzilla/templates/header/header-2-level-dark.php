<?php
/**
 * Template for displaying the "2 Level Dark" header.
 *
 * @link https://codex.wordpress.org/Template_Hierarchy
 */
?>
<header id="masthead" role="banner" class="site-header site-header-v2-dark">
	...
	<div class="<?php echo cartzilla_header_is_sticky() ? 'navbar-sticky' : ''; ?>">
		<div class="<?php cartzilla_navbar_class( 'navbar-dark bg-dark' ); ?>">
