			...
			<div class="wcfm_welcomebox_user_details rgt">
				<h3>
				  ...
				  if( !wp_is_mobile() && apply_filters( 'wcfm_is_allow_site_name_in_welcome_text', true ) ) {
				  	echo apply_filters( 'wcfm_dashboard_welcometext', sprintf( __('Bem-vindo ao painel de vendas', 'wc-frontend-manager' ), get_bloginfo() ) );
				  } else {
				  	echo apply_filters( 'wcfm_dashboard_welcometext', __('Bem-vindo ao gerenciador de vendas', 'wc-frontend-manager' ) );
				  }
				  ?>
				</h3>
